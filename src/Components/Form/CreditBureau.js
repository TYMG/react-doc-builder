...
class CreditBureauFormComponent extends Component {
    constructor(props) {
        super(props)
        this.state = {
        }
    ...
    render() {
        ...
        return (
            <div className="creditBureau__form-main">
                    ...
                    <form name="sectionForm" onSubmit={e => this.handleSubmit(e)}>
                        <FormSection name={this.calculateFormSectionName()}>
                            <div className="reference1__form-section-1 margin-btm-2">
                                ...
                                <Field key="address1" name="address1" type="text" component={FormField} label="Address Line 1" />
                                <Field key="address2" name="address2" type="text" component={FormField} label="Address Line 2" />
                                ...
                                <Field key="zip" name="zip" type="text" component={FormField} label="Zip" />
                                <Field key="phone" name="phone" type="text" component={FormField} label="Phone Number" />
                            </div>
                        </FormSection>
...
const CreditBureau = withRouter(connect(
    mapStateToProps,
    mapDispatchToProps
)(CreditBureauFormComponent))
