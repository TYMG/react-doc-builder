...
class SchoolComponent extends Component {
                        ...
                        <form name="sectionForm" onSubmit={ e => this.handleSubmit(e)}>
                            <FormSection name={this.calculateFormSectionName()}>
                               <div className="reference1__form-section-1">
                                   ...
                                   <Field key="city" name="city" type="text" component={FormField} label="School City" />
                                   <Field key="state" name="state" type="text" component={FormField} label="School State" />
                                   <Field key="zip" name="zip" type="text" component={FormField} label="School Zip" />
                                   <Field key="phoneNumber" name="phoneNumber" type="text" component={FormField} label="Phone Number" />
                                   <Field key="schoolCode" name="schoolCode" type="text" component={FormField} label="School Code" />
    ...
    const School = withRouter(connect(
        mapStateToProps,
        mapDispatchToProps
    )(SchoolComponent))
